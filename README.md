...
Downloads run in the plugin's global entry, which lives as long as IINA itself: starting playback, opening another window or closing the window a download was started from does not interrupt it, and every window shows the same Downloads panel.
